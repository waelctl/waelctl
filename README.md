...
☁️ Cloud Engineer | 🚀 Founder [@ArkOps](https://arkops.io) | 🛠️ DevOps & Infra for Startups | 🏠 Homelab, Automation & AI | 📷 Street Photographer | 📍 Paris 🇹🇳🇫🇷
...
My self-hosted infrastructure running on a Proxmox cluster with Norse mythology naming:

```
⚡ Asgard    → GPU/AI workloads
🌍 Midgard   → Application stacks  
🌊 Vanheim   → Edge services
🧊 Jotunheim → NAS storage
```

*Consul service discovery · Traefik · CrowdSec · Zero open ports*
